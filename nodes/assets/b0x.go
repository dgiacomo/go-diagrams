// Code generated by fileb0x at "2023-09-21 09:26:25.175021883 -0500 CDT m=+0.812358502" from config file "b0x.yml" DO NOT EDIT.
// modification hash(6be6ee8054c4ed892c93cb98e9f58d5c.be89261af1c9c296ff68287d42ae713a)
...
func init() {
	...
	err = FS.Mkdir(CTX, "assets/digitalocean/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/digitalocean/network/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/digitalocean/storage/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/digitalocean/database/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/digitalocean/compute/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/security/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/gitops/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/queue/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/client/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/proxmox/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/logging/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/certificates/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/search/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/cd/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/tracing/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/auth/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/iac/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/identity/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/network/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/mlops/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/container/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/workflow/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/monitoring/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/vcs/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/storage/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/dns/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/analytics/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/aggregator/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/groupware/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/ci/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/inmemory/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/database/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/etl/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/registry/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/compute/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/onprem/messaging/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/ibm/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/social/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/security/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/blockchain/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/devops/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/applications/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/infrastructure/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/user/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/network/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/data/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/storage/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/analytics/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/compute/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/management/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/ibm/general/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/saas/filesharing/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/saas/communication/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/gcp/operations/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/programming/runtime/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/programming/flowchart/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/k8s/chaos/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/elastic/beats/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/elastic/agent/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/nfv/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/packaging/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/billing/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/openstack/optimization/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/openstack/deployment/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/multiregion/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/monitoring/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/openstack/containerservices/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
