...
func (c *analyticsContainer) EmrEngineMaprM3(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/analytics/emr-engine-mapr-m3.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *analyticsContainer) EmrEngine(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/analytics/emr-engine.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
...
func (c *analyticsContainer) EmrEngineMaprM5(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/analytics/emr-engine-mapr-m5.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
...
func (c *analyticsContainer) EmrEngineMaprM7(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/analytics/emr-engine-mapr-m7.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
...
func (c *analyticsContainer) DataLakeResource(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/analytics/data-lake-resource.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
