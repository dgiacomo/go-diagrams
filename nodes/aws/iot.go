...
func (c *iotContainer) IotCoffeePot(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/iot/iot-coffee-pot.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
...
func (c *iotContainer) IotMedicalEmergency(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/aws/iot/iot-medical-emergency.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
