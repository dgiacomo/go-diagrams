...
func (c *clientContainer) Client(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/onprem/client/client.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *clientContainer) User(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/onprem/client/user.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *clientContainer) Users(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/onprem/client/users.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
