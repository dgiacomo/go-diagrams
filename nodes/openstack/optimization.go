...
func (c *optimizationContainer) Congress(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/openstack/optimization/congress.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *optimizationContainer) Rally(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/openstack/optimization/rally.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *optimizationContainer) Vitrage(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/openstack/optimization/vitrage.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}

func (c *optimizationContainer) Watcher(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/openstack/optimization/watcher.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
